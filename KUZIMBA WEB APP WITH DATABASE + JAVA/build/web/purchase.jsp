...
<div class="w3-container w3-half">
    <a href="cashin.jsp"  class="w3-btn w3-black w3-round" style="width: 100px; margin-left: 20px;">Statement <i class="fas fa-pen"></i> </a> <button  class="w3-btn w3-black w3-round" style="width: 100px; margin-left: 20px;">Cash Out </button>
</form>	
</div>
