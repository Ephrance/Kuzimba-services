...
<div class="w3-container  w3-responsive" id="tabl">
	<h3 class="">WITHDRAW SUCCESS NOTIFICAION</h3>
<br>

<div class="w3-container w3-padding w3-center" id="note"><p>You have successfully withdrawn ...</p> </div>
...
<div class="w3-container w3-half" style="margin-top: 20px;">
	  <button  class="w3-btn w3-black w3-round" style="width: 150px; margin-left: 20px;"><a href="withdraw.jsp">New Withdraw</a>  </button> <button  class="w3-btn w3-black w3-round" style="width: 150px; margin-left: 20px;"><a href="cashout.jsp">Statement</a> </button>
    <button  class="w3-btn w3-black w3-round" style="width: 150px; margin-left: 20px;"><a href="cashin.jsp">Cash In</a> </button>
</div>
</div>
